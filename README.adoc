...
[.left]
image::https://sonarcloud.io/api/project_badges/measure?project=de.dmeiners.mapping%3Amapping-impl-java&metric=alert_status[link="https://sonarcloud.io/api/project_badges/measure?project=de.dmeiners.mapping%3Amapping-impl-java&metric=alert_status"]
--
